...
public class MyFrameClass extends javax.swing.JFrame {
    public MyFrameClass() {
        initComponents();
        get
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyFrameClass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
